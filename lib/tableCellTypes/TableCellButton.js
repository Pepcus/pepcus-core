...
function TableCellButton(props) {
  var col = props.col,
      ...
      rest = (0, _objectWithoutProperties2.default)(props, ["col", "setRef", "row", "cellProps"]);
  return _react.default.createElement(_Button.default, Object.assign({
    ref: setRef
  }, rest, cellProps), (0, _get2.default)(row, cellProps.key) || (0, _get2.default)(row, col.id) || (0, _get2.default)(cellProps, 'value'));
}
