...
export const addSchemaValue = (schema = {}, path = '', value = null, mutate = true) => {
  ...
  const schemaClone = _cloneDeep(schema); // Mutate the copied schema with the required value @ path.


  _set(schemaClone, path, value); // Return the updated copied schema. Mutation free.
