...
export const isClassComponent = Component => Boolean(Component && Component.prototype && typeof Component.prototype.render === 'function');
/**
...
export const isDOMTypeComponent = Component => Boolean(typeof Component === 'string' && !Component.prototype);
/**
...
export const isReactComponent = Component => Boolean(isFunctionalComponent(Component) || isStyledComponent(Component) || isClassComponent(Component));
/**
...
export const getContainer = (container, defaultContainer) => {
  ...
  return el && typeof el === 'object' && Object.hasOwnProperty.call(el, 'current') ? el.current || defaultContainer : findDOMNode(el) || defaultContainer;
};
/**
