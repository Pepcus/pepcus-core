...
})(["margin-left:auto;margin-right:auto;position:relative;width:100%;", ";", ";"], ({
  margin,
  padding,
  theme,
  width
}) => css(["", ";", ";", ";"], renderStyle('width', width, theme), renderStyle('padding', padding, theme), renderStyle('margin', margin, theme)), getThemeProps('Container.styles'));
Container.propTypes = {
  /**
   * @ignore
   */
