...
const SvgIcon = styled.svg.attrs(props => ({
  ...
  theme,
  width
}) => css(["display:inline-block;fill:currentColor;flex-shrink:0;transition:all 1s ease-in-out;user-select:none;", ";", ";", ";", ";", ";", ";"], renderStyle('color', color || 'inherit', theme, false, renderPaletteColor('color', 'color')), renderStyle('height', height, theme), renderStyle('margin', margin, theme), renderStyle('opacity', opacity, theme), renderStyle('padding', padding, theme), renderStyle('width', width, theme)));
SvgIcon.propTypes = {
  /**
