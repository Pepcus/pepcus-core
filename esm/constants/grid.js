...
export const DISPLAY = ['block', 'inline', 'table', 'flex', 'grid', 'none', 'inline-block', 'inline-flex', 'inline-grid'];
/**
...
export const JUSTIFY_CONTENT = ['center', 'flex-end', 'flex-start', 'normal', 'space-around', 'space-between', 'space-evenly'];
/**
...
export const ALIGN_CONTENT = ['center', 'end', 'flex-end', 'flex-start', 'normal', 'start', 'stretch'];
/**
 * List of available css 'align-content' values
 *
 * @type {Array}
