...
export const COLORS = _objectSpread({}, ROOT_COLORS, {
  ...
  SUCCESS_GRADIENT: `linear-gradient(to bottom, ${lighten(0.2, ROOT_COLORS.SUCCESS)}, ${ROOT_COLORS.SUCCESS})`,
  LIGHT_GRADIENT: `linear-gradient(to bottom, ${ROOT_COLORS.LIGHT}, ${darken(0.2, ROOT_COLORS.LIGHT)})`,
