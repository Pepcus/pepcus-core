...
function TableCellDate(_ref) {
  ...
  var timezone = (0, _get2.default)(cellProps, 'timezone');
  ...
  var date = (0, _date.formatDate)(value, format, timezone); // FIX: for the `date-fns` library, where if we send an invalid date, or none at all,
