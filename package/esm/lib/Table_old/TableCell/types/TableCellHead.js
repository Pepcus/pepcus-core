...
import TableCellCSS from "../TableCellCSS"; // eslint-disable-next-line valid-jsdoc
...
const TableCellHead = styled.th.withConfig({
  displayName: "TableCellHead",
  componentId: "sc-1md71m1-0"
})(["", ";font-weight:", ";", ";", ";"], TableCellCSS, getThemeProps('typography.fontWeights.regular'), ({
  schema
}) => {
