...
})(["align-items:center;border-radius:5px;border:none;display:flex;flex-direction:row;justify-content:space-between;padding:0 15px;", ";"], getThemeProps('MenuButton.styles'));
