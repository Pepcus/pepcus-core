import SvgIcon from "./SvgIcon"; // Import in the rest of the icons
...
SvgIcon.types = types; // Default export the SvgIcon

export default SvgIcon;
export { AlertIcon, ArrowIcon, CheckboxEmptyIcon, CheckboxIcon, CheckboxIndeterminateIcon, ChevronIcon, ClearIcon, GearIcon, KeyIcon, MenuIcon, PhoneIcon, SearchIcon, GridIcon, TrashIcon };