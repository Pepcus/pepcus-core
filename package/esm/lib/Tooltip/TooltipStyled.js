...
const TooltipStyled = styled.div.withConfig({
  displayName: "TooltipStyled",
  componentId: "sc-308d57-0"
})(["", ";border-radius:4px;max-width:400px;padding:15px;position:relative;&:after{border:solid transparent;content:' ';height:0;width:0;position:absolute;pointer-events:none;border-color:transparent;border-width:", ";}", ";", ";", ";"], getThemeProps('typography.caption'), ({
  arrowSize
}) => `${arrowSize}px`, getThemeProps('Tooltip.styles'), ({
  maxWidth,
  padding,
  theme,
  color: colorProps
