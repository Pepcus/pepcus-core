...
import { renderCSSColSize, renderColumnGutter, renderLeftOffset, renderRightOffset, verifyCSSColSize, verifyCSSFlexOrder, verifyCSSValueCurry } from "../../utils/css";
/* eslint-disable react/prop-types */

const ColStyled = forwardRef((props, ref) => {
  const tagname = props.tagname;
  return createElement(tagname, _objectSpread({}, filterProps(props), {
    ref
  }));
});
...
const Col = styled(ColStyled).withConfig({
  displayName: "Col",
  ...
  return css(["", ";", ";", ";", ";", ";", ";", ";", ";", ";", ";"], renderStyle('display', display, theme), renderStyle('size', size, theme, verifyCSSColSize, renderCSSColSize), renderStyle('gutter', gutter, theme, true, renderColumnGutter), renderStyle('align-self', alignSelf, theme, verifyCSSValueCurry(ALIGN_SELF)), renderStyle('flex', flex, theme), renderStyle('order', order, theme, verifyCSSFlexOrder), renderStyle('leftOffset', leftOffset, theme, true, renderLeftOffset), renderStyle('rightOffset', rightOffset, theme, true, renderRightOffset), renderStyle('padding', padding, theme), renderStyle('margin', margin, theme));
});
Col.propTypes = {
  /**
