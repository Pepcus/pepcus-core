...
export const formatDate = (timestamp, dateFormat, timezone) => timezone ? formatToTimeZone(timestamp, dateFormat || 'MM/DD/YYYY', {
  timeZone: timezone
...
export const formatJapiTimestamp = timestamp => {
